import { BrainCircuit, Database, LayoutDashboard, Settings2, Stethoscope } from "lucide-react";
...
export function AppShell() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-cyan-50/45">
      <div className="mx-auto grid max-w-[1760px] grid-cols-1 gap-8 px-5 py-7 lg:grid-cols-[260px_minmax(0,1fr)] lg:px-10">
        <aside className="rounded-2xl border border-slate-200 bg-white p-4 shadow-[0_14px_34px_-26px_rgba(15,23,42,0.45)]">
          <div className="mb-5 rounded-xl bg-sky-700 px-3 py-4 text-white">
            ...
            <h1 className="mt-1 text-lg font-semibold leading-tight">Site Enrollment Intelligence</h1>
          </div>
              ...
              return (
                <NavLink
                  ...
                  className={({ isActive }: { isActive: boolean }) =>
                    cn(
                      "flex items-center gap-2.5 rounded-lg px-3 py-2.5 text-base font-medium text-slate-600 transition-colors",
